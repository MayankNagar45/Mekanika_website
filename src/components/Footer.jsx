      ...
      <div className="container max-w-screen-xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-10 gap-8">
          ...
          <div className="md:col-span-1 lg:col-span-4 flex flex-col items-center md:items-start">
            <h2 className="text-2xl font-bold text-yellow-400 mb-4 it">
              Quick Links
            </h2>
            <ul className="grid grid-cols-2 gap-x-8 gap-y-2 text-gray-300  text-center md:text-left">
              ...
              {/*text-center */}
              <li>
                <Link to="/research-areas" className="hover:text-yellow-400">
                  Research Areas
                </Link>
              </li>
             
              <li>
                <Link to="/core-expedition" className="hover:text-yellow-400">
                  Core Expedition
                </Link>
              </li>
                 
              <li>
                <Link to="/intern-chronicles" className="hover:text-yellow-400">
                  Intern Chronicles
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/course-material" className="hover:text-yellow-400">
                  Materials
                </Link>
              </li>
            
              <li>
                <Link to="/dep-map" className="hover:text-yellow-400">
                  Dep Map
                </Link>
              </li>
              <li>
          ...
          <div className="md:col-span-1 lg:col-span-3 flex flex-col items-center md:items-start lg:items-center">
            <div className="mb-4 relative flex items-center">
              ...
              />
              <h1 className="text-[1.7rem] font-bold text-yellow-400">
                MEKANIKA
              </h1>
            </div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/mekanika_iitkgp?fbclid=IwAR0Zjcbj4FTv6DhzYw3wU97I-Jw9Wkn0-ZS5aYh-nn9OGgy3j4BkiMLfGM4"
                className="text-gray-300 hover:text-yellow-400"
              >
                <FontAwesomeIcon icon={faInstagram} size="2x" />
              </a>
              <a
                href="https://www.linkedin.com/company/mekanika-iit-kharagpur/about/"
                className="text-gray-300 hover:text-yellow-400"
              >
                <FontAwesomeIcon icon={faLinkedin} size="2x" />
              </a>
              <a
                href="https://www.facebook.com/mekanikaiitkgp/"
                className="text-gray-300 hover:text-yellow-400"
              >
                <FontAwesomeIcon icon={faFacebook} size="2x" />
              </a>
              <a
                href="https://medium.com/@mekanika2022"
                className="text-gray-300 hover:text-yellow-400"
              >
        ...
        <div className="text-center mt-8 pt-4 ">
          ...
          <p className="text-gray-500 mb-1">
            &copy; {new Date().getFullYear()} Mekanika IIT Kharagpur. All Rights
            Reserved.
          </p>
        </div>
      </div>
